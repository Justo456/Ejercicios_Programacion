...
import GitHub_Programacion.Paquetes.Paquete_funciones.Funciones_matrices as fun

ret = fun.inicilizador_de_matriz(3,5,0)

fun.cargar_matriz_aleatoriamente(ret,3,5)

fun.alinea_filas(ret)
